...
char *se[] = {
  ...
  "Svar" ,                          /* Reply              -HTML*/
  "Angende den här listan",      /* About this list    -HTML*/
  ...
  "Slutar",                         /* Ending             -HTML*/
  "Angående det här arkivet", /* About this archive -HTML*/
  "sorterat på",                 /* Messages sorted by -HTML*/
  "Andra brevarkiv",                /* Other mail archives-HTML*/
  "På Datum",                    /* By Date            -HTML*/
  ...
  "Senaste brev datum",             /* Last message date  -HTML*/
  ...
  "Nästa i trden",               /* Next in thread     -HTML*/
  "Kanske svar",                    /* Maybe reply        -HTML*/
  "Per tråd",                    /* By Thread          -HTML*/
  "Per ämne",                    /* By Subject         -HTML*/
  "Per författare",              /* By Author          -HTML*/
  "Kan inte skapa directory",       /* Can not create directory -STDERR*/
  "Skapar directory",               /* Creating directory -STDOUT*/
  ...
  "Ja",                             /* Yes               -STDOUT*/
  "Nej",                            /* No                -STDOUT*/
  "Angående arkivet: ej använd",      /* About the archive: not used-STDOUT */
  ...
  "Directory att spara HTML-filerna i", 
                            /* The directory to save HTML files in -STDOUT*/
  "Läs breven från standard input", /* Read messages from standard input-STDOUT*/
  ...
  "Skapade bifogningsfil",          /* Created attachment file -STDOUT*/
  "bifogning",                      /* attachment              -HTML*/
  "mode",                           /* mode                    -STDOUT*/
