...
char *de[] = {       /* German */
  ...
  "Antwort",                              /* Reply              -HTML*/
  "άber diese Liste",                  /* About this list    -HTML*/
  ...
  "Ende",                                 /* Ending             -HTML*/
  "άber dieses Archiv",                /* About this archive -HTML*/
  ...
  "Titel",                              /* subject             -HTML*/
  "fόr Optionen",                      /* for options       -STDOUT*/
  ...
  "Kann Dateimodus nicht δndern",      /* Can not chmod     -STDERR*/
  "Kann nicht schreiben",                 /* Could not write   -STDERR*/
  "Nδchste Nachricht",                 /* Next message        -HTML*/
  ...
  "Nδchste zum Thema",           	  /* Next in thread      -HTML*/
  ...
  "Kann E-Mail-Archiv nicht φffnen",     /* Cannot open mail archive */
  "Lese neue Kopfzeilen...",                  /* Reading new header...-STDOUT*/
  "Lade Mailbox",                         /* Loading mailbox      -STDOUT*/
  "Kodierung wird nicht unterstόtzt, speichere so", 
  ...
  "Ja",                                   /* Yes                -STDOUT*/
  "Nein",                                 /* No                 -STDOUT*/
  "άber das Archiv: nicht benutzt",    /* About the archive: not used-STDOUT */
  ...
  "URL fόr weitere Archive",              /* URL to other archives  -STDOUT*/
  "URL fόr Informationen όber Archiv",  
  ...
  "Jeweils einen Artikel hinzufόgen",  /* Update archive by one article -STDOUT*/
  "Vorherige Nachrichten όberschreiben", /* Overwrite previous messages -STDOUT*/
  "Sprache angeben",                      /* Specify language to use -STDOUT*/
  "Anleitung",                                /* Usage -STDOUT*/
  "Die Sprache wird nicht unterstόtzt",/* Language not supported  -STDERR*/
  ...
  "FEHLER",                       /* ERROR                       -STDERR*/
  "Einsendeadresse fόr die Liste", 
                           /* The submission address of the list-STDERR*/
  "Lese nur eine E-Mail aus der Eingabe",
  "Autor",                                /* author              -HTML*/
  "Datum",                                /* date                -HTML*/
  "Titel",                                /* subject             -HTML*/
  "Aktionsmφglichkeiten",                 /* Mail actions (MA) header -HTML*/
  ...
  "Zusammenfassung der monatlichen Index-Dateien", 
  					  /* monthly             -HTML*/
  "Zusammenfassung der jδhrlichen Index-Dateien",        
  					  /* yearly              -HTML*/
  "Lege GDBM-Zwischenspeicher fόr Kopfzeilen an", 
  ...
  "Pflege ein zusδtzliches mbox-Archiv", /* Maintain an mbox archive -STDOUT*/
  "Can't both read from and write to an mbox.", 
  	       /* "Can't both read from and write to an mbox." -STDOUT*/
  "Anhδnge-άbersicht",                      /* Attachment view       -HTML*/
  ...
  "Nδchsts Verzeichnis",                 /* MSG_NEXT_DIRECTORY  -HTML */
  ...
  "(gelφschte Nachricht)",          /* MSG_DEL_SHORT            -HTML */
  "Ursprόnglicher Text dieser Nachricht", /* MSG_TXT_VERSION    -HTML */
...
/*
** Polish version of the language table (Polska wersja tabeli jκzykowej)
** Translation by Adam T. Tkocz <adam@storm.pl>
*/

char *pl[] = {                      /* English */
  "Nowa wiadomo¶ζ",                 /* New Message        -HTML*/
  "Odpowiedz",                      /* Reply              -HTML*/
  "O tej li¶cie",                   /* About this list    -HTML*/
  "Dσ³ strony",                     /* End of Messages    -HTML*/
  "Gσra strony",                    /* Start of Messages  -HTML*/
  "Wg daty",                        /* Date view          -HTML*/
  "Wg w±tkσw",                      /* Thread view        -HTML*/
  "Wg tematσw",                     /* Subject view       -HTML*/
  "Wg autorσw",                     /* Author view        -HTML*/
  ...
  "Naj¶wieΏsze wiadomo¶ci",         /* Most recent messages-HTML*/
  "autora",                         /* author              -HTML*/
  "datay",                          /* date                -HTML*/
  "w±tku",                          /* thread              -HTML*/
  "tematu",                         /* subject             -HTML*/
  ...
  "Zapisywanie indeksu w±tkσw do",  /* Writing thread index to -STDOUT*/
  "Zapisywanie indeksu tematσw do", /* Writing subject index to-STDOUT*/
  "Zapisywanie indeksu autorσw do", /* Writing author index to-STDOUT*/
  "Data ostatniej wiadomo¶ci",      /* Last message date   -HTML*/
  "Zarchiwizowane w",               /* Archived on         -HTML*/
  "Niedozwolone chmod",             /* Can not chmod     -STDERR*/
  "Nie moΏna zapisaζ",              /* Could not write   -STDERR*/
  "Nastκpna wiadomo¶ζ",             /* Next message        -HTML*/
  "Poprzednia wiadomo¶ζ",           /* Previous message    -HTML*/
  "Przypuszczalnie w odpowiedzi na",/* Maybe in reply to   -HTML*/
  "W odpowiedzi na",                /* In reply to         -HTML*/
  "Nastκpna w w±tku",               /* Next in thread      -HTML*/
  "Prawdopodobna odpowiedΌ",        /* Maybe reply         -HTML*/
  "Wg w±tku",                       /* By Thread           -HTML*/
  "Wg tematu",                      /* By Subject          -HTML*/
  "Wg autora",                      /* By Author           -HTML*/
  "Nie moΏna stworzyζ katalogu",    /* Can not create directory -STDERR*/
  "Tworzenie katalogu",             /* Creating directory -STDOUT*/
  "Parametry konfiguracji",         /* Configuration Values -STDOUT*/
  "¶cieΏka",                        /* path              -STDOUT*/
  "Przekroczona pamiκζ!",           /* Ran out of memory!-STDERR*/
  "To archiwum zosta³o wygenerowane przez",  /* This archive was generated by -HTML*/
  "Elementy",                       /* Elements          -STDOUT*/
  "―adnych elementσw",              /* No Elements       -STDOUT*/
  "Nie moΏna otworzyζ archiwum",    /* Cannot open mail archive */
  "Czytanie nowego nag³σwka",       /* Reading new header... -STDOUT   */
  ...
  "Tak",                            /* Yes                -STDOUT*/
  "Nie",                            /* No                 -STDOUT*/
  "O tym archiwum: nie uΏywane",    /* About the archive: not used-STDOUT */
  "Inne archiwa: nie uΏywane",      /* Other archives: not used-STDOUT*/
  "adres nie zosta³ uΏyty",         /* address not used -STDOUT*/
  "Wbudowane <BODY> zosta³o uΏyte", /* Builtin <BODY> statement used-STDOUT*/
  "Nie moΏna odczytaζ pliku ani stdin.", /* Cannot read from both file and stdin. -STDERR*/
  "Opcje",                          /* Options                -STDOUT*/
  "URL do innych arciwσw",          /* URL to other archives  -STDOUT*/
  ...
  "Katalog do zapisu plikσw HTML",  /* The directory to save HTML files in -STDOUT*/
  "Czytaj wiadomo¶ci z stdin",      /* Read messages from standard input -STDOUT*/
  "Podaj nazwκ archiwum",           /* What to name the output archive -STDOUT*/
  "Archiwum do wczytania",          /* Mail archive to read in -STDOUT*/
  "PokaΏ postκpy",                  /* Show progress           -STDOUT*/
  "PokaΏ tylko zmienne konfiguracyjne", /* Show configuration variables only -STDOUT*/
  "PokaΏ wersjκ i wyjdΌ",           /* Show version information and exit -STDOUT*/
  "Uzupelnij archiwum o jedn± wiadomo¶ζ", /* Update archive by one article -STDOUT*/
  "Zast±p poprzednia wiadomo¶ζ",    /* Overwrite previous messages -STDOUT*/
  "Wybierz uΏywany jκzyk",          /* Specify language to use     -STDOUT*/
  "UΏycie",                         /* Usage                       -STDOUT*/
  "Jκzyk nie jest wspierany",       /* Language not supported  -STDERR*/
  "Nie ustawione",                  /* Not set     -STDOUT*/
  "Nie uΏywane",                    /* Not used  -STDOUT*/
  "Stworzono za³±cznik",            /* Created attachment file     -STDOUT*/
  "za³±cznik",                      /* attachment                    -HTML*/
  "tryb",                           /* mode                        -STDOUT*/
  "Czytanie starych nag³σwkσw",     /* Reading old headers      -STDOUT*/
  "",                               /* tylko do wyrσwnania       -STDOUT*/
  "B£΅D",                           /* ERROR                       -STDERR*/
  "Adres wypisuj±cy z listy",       /* The submission address of the list-STDERR*/
  "Czytaj tylko jedn± wiadomo¶ζ",
  "Autor",                          /* author              -HTML*/
  "Data",                           /* date                -HTML*/
  "Temat",                          /* subject             -HTML*/
  "Wybierz",                        /* Mail actions (MA) header -HTML*/
  "wy¶lij nowy temat",              /* MA New Message      -HTML*/
  "odpowiedz na t± wiadomo¶ζ",      /* MA Reply            -HTML*/
  "Zestawienie miesiκcy",           /* monthly             -HTML*/
  "Zestawienie lat",                /* yearly              -HTML*/
  "Utwσrz cache nag³owkσw GDBM",    /* Build a GDBM header cache -STDOUT*/
  "GDBM header cache option not build in",
  		      /* GDBM header cache option not build in  -STDERR*/
  "Tworzenie indeksu GDBM... ",     /* Creating gdbm index -STDOUT*/
  "Nie moΏna utworzyζ pliku GDBM... ",  /* Can't create gdbm index     -STDOUT*/
  "Zachowaj archiwum mbox",         /* Maintain an mbox archive    -STDOUT*/
  "Nie moΏna odczytaζ ani zapisaζ mailboxa.", /* "Can't both read from and write to an mbox." -STDOUT*/
  "Wg za³±cznikσw",                  /* Attachment view -HTML*/
  "Wg wiadomo¶ci z za³±cznikami",    /* By messages with attachments -HTML*/
  "Zapisywanie indeksu za³±cznikσw", /* Writing attachment index to -STDOUT*/
  "bajtσw",                          /* file size, so far only for attachments  -HTML */
  "Nie moΏna stworzyζ aliasa",       /* MSG_CANNOT_CREATE_SYMLINK -STDOUT */
  "Nie moΏna usun±ζ pliku",          /* MSG_CANNOT_UNLINK      -STDOUT */
  "Poprzedni katalog",               /* MSG_PREV_DIRECTORY  -HTML */
  "Nastκpny katalog",                /* MSG_NEXT_DIRECTORY    -HTML */
  "Lista Katalogσw",                 /* MSG_FOLDERS_INDEX   -HTML */
  "Ta wiadomo¶ζ zosta³a usuniκta z archiwum", /* MSG_DELETED  -HTML */
  "Ta wiadomo¶ζ jest przedawniona",  /*MSG_EXPIRED -HTML */
  "(usuniκta wiadomo¶ζ)",            /* MSG_DEL_SHORT     -HTML */
  "Tekst tej zawarto¶ci",            /* MSG_TXT_VERSION     -HTML */
  "Ta wiadomo¶ζ zosta³a odfiltrowana",        /* MSG_FILTERED_OUT -HTML */
  "Autor",                          /* MSG_FROM              -HTML*/
...
char *es[] = {       /* Espanol/Spanish */
  ...
  "Por conversaciσn",         	      /* Thread view  		      - HTML  */
  ...
  "Ϊltimos mensajes",                 /* Most recent messages 	      - HTML  */
  "autor",                            /* author 		      - HTML  */
  "fecha",                            /* date 			      - HTML  */
  "Hilo de conversaciσn",             /* thread 		      - HTML  */
  "tema",                             /* subject 		      - HTML  */
  "para las opciones",                /* for options 	 	      - STDOUT*/
  "Escribiendo mensajes en",          /* Writing articles to 	      - STDOUT*/
  "Escribiendo νndice de fechas en",  /* Writing date index to        - STDOUT*/
  "Escribiendo νndice de conversaciones en",
  				      /* Writing thread index to      - STDOUT*/
  "Escribiendo νndice de temas en",   /* Writing subject index to     - STDOUT*/
  "Escribiendo νndice de autores en", /* Writing author index to      - STDOUT*/
  "Fecha del ϊltimo mensaje",         /* Last message date 	      - HTML  */
  ...
  "Siguiente en conversaciσn",        /* Next in thread 	      - HTML  */
  "Posible respuesta",                /* Maybe reply  		      - HTML  */
  "Por conversaciσn",                 /* By Thread  		      - HTML  */
  ...
  "Parαmetros de configuracσn",       /* Configuration Values         - STDOUT*/
  "ruta",                             /* path 			      - STDOUT*/
  ...
  "codificaciσn no soportada, grabado -tal cual-", 
	                     /* encoding is not supported, stored as-is - HTML*/

  "mensajes",                         /* articles */
  "Versiσn",                          /* Version 		      - STDOUT*/
  ...
  "direcciσn no utilizada",           /* address not used 	      - STDOUT*/
  ...
  "URL de informaciσn de archivos",   /* URL to archive information   - STDOUT*/
  ...
  "Mostrar informaciσn de versiσn y salir",   
  ...
  "",                                 /* (for alignment only)         - STDOUT*/
  "ERROR",                            /* ERROR                        - STDERR*/
  "Direcciσn de correo de la lista",  
  				/* The submission address of the list - STDERR*/
  "Leer sσlo un mensaje de la entrada",
  			       /* Read only one mail from input		      */
  "Autor",                            /* author	 		      - HTML  */
  "Fecha",                            /* date 			      - HTML  */
  "Tema",                             /* subject		      - HTML  */
  ...
  "Resumen de νndices mensuales",     /* monthly            	      - HTML  */
  "Resumen de νndices anuales",       /* yearly              	      - HTML  */
  "Costruir cabecera para cachι GDBM",/* Build a GDBM header cache    - STDOUT*/
  "Creando νndice gdbm... ",          /* Creating gdbm index          - STDOUT*/
  ...
  "Escribiendo νndice de adjuntos en",/* Writing attachment index to  - STDOUT*/
  "bytes",		    /* file size, so far only for attachments - HTML  */
  "No pudo crearse enlace simbσlico", /* MSG_CANNOT_CREATE_SYMLINK    - STDOUT*/
...
char *fi[] = {       /* Finnish */
  "Lδhetδ uusi viesti",              /* New Message        -HTML*/
  ...
  "Pδivδysnδkymδ",             /* Date view          -HTML*/
  "Ketjunδkymδ",                     /* Thread view        -HTML*/
  "Aihenδkymδ",                      /* Subject view       -HTML*/
  "Kirjoittajanδkymδ",               /* Author view        -HTML*/
  ...
  "Pδivδyksittδin",               /* By Date             -HTML*/
  "Tuoreimmat viestit",                    /* Most recent messages-HTML*/
  "kirjoittajittain",                      /* author              -HTML*/
  "pδivδyksittδin",               /* date                -HTML*/
  "ketjuittain",                           /* thread              -HTML*/
  "aiheittain",                            /* subject             -HTML*/
  "asetuksiin",                            /* for options       -STDOUT*/
  "Kirjoitan viestejδ",                 /* Writing messages to-STDOUT*/
  "Kirjoitan hakemistoa pδivδyksittδin", /* Writing date index to-STDOUT*/
  ...
  "Tδmδn arkiston loi",            /* This archive was generated by-HTML*/
  "Osaset",                                /* Elements          -STDOUT*/
  "Ei osasia",                             /* No Elements       -STDOUT*/
  "Ei voi avata postiarkistoa",            /* Cannot open mail archive */
  "Luen uusia otsikkorivejδ...",        /* Reading new header...-STDOUT   */
  ...
  "Kyllδ",                              /* Yes                -STDOUT*/
  "Ei",                                    /* No                 -STDOUT*/
  "Tietoa arkistosta: ei kδytφssδ", /* About the archive: not used-STDOUT */
  "Muut arkistot: ei kδytφssδ",   /* Other archives: not used-STDOUT*/
  "osoite ei kδytφssδ",           /* address not used        -STDOUT*/
  "Kδytetδδn oletus-<BODY>-rakennetta", /* Builtin <BODY> statement used-STDOUT*/
  "Ei voi lukea sekδ tiedostosta ettδ syφttφvirrasta (stdin).", /* Cannot read from both file and stdin. -STDERR*/
  ...
  "Lue viestit syφttφvirrasta (stdin)",/* Read messages from standard input -STDOUT*/
  "Talletettavan arkiston nimi",   /* What to name the output archive -STDOUT*/
  "Luettava postiarkisto",                /* Mail archive to read in -STDOUT*/
  "Nδytδ eteneminen",               /* Show progress           -STDOUT*/
  "Nδytδ vain asetusmuuttujat", /* Show configuration variables only -STDOUT*/
  "Nδytδ versiotieto ja lopeta ohjelma", /* Show version information and exit -STDOUT*/
  "Pδivitδ arkistoa yhdellδ viestillδ", /* Update archive by one article -STDOUT*/
  "Korvaa aiemmat viestit", /* Overwrite previous messages -STDOUT*/
  "Mδδritδ kδytettδvδ kieli",     /* Specify language to use     -STDOUT*/
  "Kδyttφohje",                    /* Usage                   -STDOUT*/
  "Kieli ei tuettu",                     /* Language not supported  -STDERR*/
  "Ei asetettu",                         /* Not set                 -STDOUT*/
  "Ei kδytφssδ",                /* Not used                -STDOUT*/
  "Luotu liitetiedosto",                 /* Created attachment file -STDOUT*/
  "liite",                               /* attachment              -HTML*/
  "suojaus",                             /* mode                    -STDOUT*/
  "Luen vanhoja otsikkorivejδ",       /* Reading old headers     -STDOUT*/
  "",                                    /* for alignment only      -STDOUT*/
  "VIRHE",                               /* ERROR                   -STDERR*/
  "Listan lδhetysosoite",   /* The submission address of the list-STDERR*/
  "Lue vain yksi viesti",
  "Kirjoittajan mukaan",                 /* author                    -HTML*/
  "Pδivδyksen mukaan",             /* date                      -HTML*/
...
char *fr[] = {       /* French */
  ...
  "Ecriture de l'index 'thθme' dans",      /* Writing thread index to -STDOUT*/
  ...
  "Ne peut ιcrire",                        /* Could not write   -STDERR*/
  ...
  "par Thθme",                      /* By Thread           -HTML*/
  "par Sujet",                             /* By Subject          -HTML*/
  "par Auteur",                            /* By Author           -HTML*/
  "Ne peut crιer le rιpertoire",           /* Can not create directory -STDERR*/
  "Crιation du rιpertoire",                /* Creating directory -STDOUT*/
  "Valeurs configurιes",                   /* Configuration Values -STDOUT*/
  "chemin",                                /* path              -STDOUT*/
  "Plus assez de mιmoire!",                 /* Ran out of memory!-STDERR*/
  "Cette archive a &eacute;t&eacute; cr&eacute;&eacute;e par",  /* This archive was generated by-HTML*/
  "Elιments",                              /* Elements          -STDOUT*/
  "Aucun Elιment",                         /* No Elements       -STDOUT*/
  "Ne peut ouvrir l'archive de mail",      /* Cannot open mail archive */
  "Lecture du nouvel en-tκte...",          /* Reading new header...-STDOUT   */
  "Chargement de la boite aux lettres",    /* Loading mailbox      -STDOUT   */
  "encodage non supportι, stockι tel quel",/* encoding is not supported, stored as-is -HTML*/
  "messages",                              /* messages             -HTML*/
  "Version",                               /* Version            -STDOUT*/
  "Revision",                              /* Patchlevel         -STDOUT*/
  "Documents",                             /* Docs               -STDOUT*/
  "Variables de Commande et de Contrτle",  /* Command and Control Variables-STDOUT*/
  "Oui",                                   /* Yes                -STDOUT*/
  "Non",                                   /* No                 -STDOUT*/
  "A propos de l'archive: non utilisι",    /* About the archive: not used-STDOUT */
  "Autres archives: non utilisι",          /* Other archives: not used-STDOUT*/
  "adresse non utilisιe",                  /* address not used        -STDOUT*/
  "Utilisation de la dιclaration <BODY>",  /* Builtin <BODY> statement used-STDOUT*/
  "Impossible de lire simulatanιment un fichier et le flot d'entrιe standard (stdin)", /* Cannot read from both file and stdin. -STDERR*/
  "Options",                               /* Options                -STDOUT*/
  ...
  "Fichier de configuration ΰ lire",       /* Configuration file to read in -STDOUT*/
  "Rιpertoire oω sauver les fichiers HTML",/* The directory to save HTML files in -STDOUT*/
  "Lecture des messages depuis le flot d'entrιe standard (stdin)", /* Read messages from standard input -STDOUT*/
  "Nom de l'archive de sortie",            /* What to name the output archive -STDOUT*/
  "Archive d'email ΰ lire",                   /* Mail archive to read in -STDOUT*/
  ...
  "Mettre ΰ jour l'archive d'un article",  /* Update archive by one article -STDOUT*/
  "Ecraser les messages prιcιdents",       /* Overwrite previous messages -STDOUT*/
  "Spιcifier la langue ΰ utiliser",        /* Specify language to use     -STDOUT*/
  "Utilisation",                           /* Usage           -STDOUT*/
  "Langue non supportιe",                  /* Language not supported -STDERR*/
  "Non dιfini",                            /* Not set        -STDOUT*/
  "Non utilisι",                           /* Not used       -STDOUT*/
  "Fichier attachι crιι",                  /* Created attachment file -STDOUT*/
  "fichier attach&eacute;",                /* attachment     -HTML*/
  "mode",                                  /* mode           -STDOUT*/
  "Lecture des anciens en-tκtes",          /* Reading old headers -STDOUT*/
  "",                                      /* for alignment only       -STDOUT*/
  "ERREUR",                                /* ERROR                    -STDERR*/
  "Adresse d'envoi ΰ la liste", 
                                           /* The submission address of the list-STDERR*/
  "Lire seulement un mail depuis l'entrιe",
  "Auteur",                                /* author              -HTML*/
  "Date",                                  /* date                -HTML*/
  "Sujet",                                 /* subject             -HTML*/
  ...
  "Summary of Monthly Index Files",        /* monthly             -HTML*/
  "Summary of Yearly Index Files",         /* yearly              -HTML*/
  "Creation d'un cache GDBM pour les en-tκtes",  /* Build a GDBM header cache   -STDOUT*/
  "GDBM header cache option not build in",
  		      /* GDBM header cache option not build in  -STDERR*/
  "Generation de l'index GDBM... ",               /* Creating gdbm index         -STDOUT*/
  "Impossible de crιer un fichier GDBM... ",    /* Can't create gdbm index     -STDOUT*/
  "Maintenance d'une archive email (mbox)",     /* Maintain an mbox archive    -STDOUT*/
  "Impossible de lire et d'ιcrire simultanιment dans une archive email (mbox)", /* "Can't both read from and write to an mbox." -STDOUT*/
  "Liste par fichier attachιs",            /* Attachment view  -HTML*/
  "par messages avec fichiers attachιs",    /* By messages with attachments -HTML*/
  "Ecriture de l'index 'fichiers attachιs' dans",/* Writing attachment index to -STDOUT*/
  "octets",		                   /* file size, so far only for attachments  -HTML */
  "Impossible de crιer un lien symbolique",/* MSG_CANNOT_CREATE_SYMLINK     -STDOUT */
  "Impossible de supprimer le fichier",    /* MSG_CANNOT_UNLINK                       -STDOUT */
  "Dossier prιcιdent",                     /* MSG_PREV_DIRECTORY                     -HTML */
  ...
  "Ce message a &eacute;t&eacute; supprimι par filtrage",    /* MSG_FILTERED_OUT -HTML */
...
char *is[] = {       /* Icelandic */
  "Nύtt brιf",                   /* New Message        -HTML*/
  "Svar",                              /* Reply              -HTML*/
  "Um ώennan lista",                /* About this list    -HTML*/
  "Endir safns",                       /* End of Messages    -HTML*/
  "Upphaf safns",                      /* Start of Messages  -HTML*/
  "Raπaπ e. dagssetningum",      /* Date view          -HTML*/
  "Raπaπ e. umrζπum",      /* Thread view        -HTML*/
  "Raπaπ e. viπfangsefnum",   /* Subject view       -HTML*/
  "Raπaπ e. hφfundum",        /* Author view        -HTML*/
  "Aπrir flokkar",                  /* Other groups       -HTML*/
  "Brιfum",                         /* Messages           -HTML*/
  "Frα",                            /* Starting           -HTML*/
  "Til",                               /* Ending             -HTML*/
  "Um ώetta safn",                  /* About this archive -HTML*/
  "Raπa eftir",                     /* Messages sorted by -HTML*/
  "Φnnur sφfn",                  /* Other mail archives -HTML*/
  "eftir dagssetningum",               /* By Date             -HTML*/
  "Nύjustu brιfin",              /* Most recent messages-HTML*/
  "hφfundum",                       /* author              -HTML*/
  "dags.",                             /* date                -HTML*/
  "umrζπum",                     /* thread              -HTML*/
  "viπfangsefnum",                  /* subject             -HTML*/
  "for options",                       /* for options       -STDOUT*/
  "Writing messages to",               /* Writing messages to-STDOUT*/
  "Writing date index to",             /* Writing date index to-STDOUT*/
  "Writing thread index to",           /* Writing thread index to -STDOUT*/
  "Writing subject index to",          /* Writing subject index to-STDOUT*/
  "Writing author index to",           /* Writing author index to-STDOUT*/
  "Dags. sνπasta brιfs",      /* Last message date   -HTML*/
  "Sνπasta brιf mσttekiπ", /* Archived on         -HTML*/
  "Can not chmod",                     /* Can not chmod     -STDERR*/
  "Could not write",                   /* Could not write   -STDERR*/
  "Nζsta brιf",                  /* Next message        -HTML*/
  "Fyrra brιf",                     /* Previous message    -HTML*/
  "Mφgulega ν frh. af",          /* Maybe in reply to   -HTML*/
  "Ν framhaldi af",                 /* In reply to         -HTML*/
  "Nζst ν umrζπu",         /* Next in thread      -HTML*/
  "Mφgulegt svar",                  /* Maybe reply         -HTML*/
  "eftir umrζπum",               /* By Thread           -HTML*/
  "eftir viπfangsefnum",            /* By Subject          -HTML*/
  "eftir hφfundum",                 /* By Author           -HTML*/
  "Can not create directory",          /* Can not create directory -STDERR*/
  "Creating directory",                /* Creating directory -STDOUT*/
  "Configuration Values",              /* Configuration Values -STDOUT*/
  "path",                              /* path              -STDOUT*/
  ...
  "Reading new header...",             /* Reading new header...-STDOUT   */
  "Loading mailbox",                   /* Loading mailbox      -STDOUT   */
  "framandi kσπun, geymt σbreytt", /* encoding is not supported, stored as-is -HTML*/
  "brιf.",                          /* messages             -HTML*/
  "Version",                           /* Version            -STDOUT*/
  "Patchlevel",                        /* Patchlevel         -STDOUT*/
  "Docs",                              /* Docs               -STDOUT*/
  ...
  "The submission address of the list", 
                           /* The submission address of the list-STDERR*/
  "Read only one mail from input",
  "Hφfundur",                      /* author              -HTML*/
  "Dagssetning",                      /* date                -HTML*/
  "Viπfangsefni",                  /* subject             -HTML*/
  "Mail actions",                     /* Mail actions (MA) header -HTML*/
  "mail a new topic",                 /* MA New Message      -HTML*/
  "respond to this message",          /* MA Reply            -HTML*/
  "Summary of Monthly Index Files",   /* monthly             -HTML*/
...
char *sv[] = {
  ...
  "Svar" ,                          /* Reply              -HTML*/
  "Om den hδr listan",      /* About this list    -HTML*/
  "Slut pε brevlistan",          /* End of Messages    -HTML*/
  "Start pε brevlistan",         /* Start of Messages  -HTML*/
  "Datumvy",                        /* Date view          -HTML*/
  "Trεdvy",                      /* Thread view        -HTML*/
  "Δmnesvy",                     /* Subject view       -HTML*/
  "Fφrfattarvy",                 /* Author view        -HTML*/
  "Andra grupper",                  /* Other groups       -HTML*/
  "Brev",                           /* Messages           -HTML*/
  "Startar",                        /* Starting           -HTML*/
  "Slutar",                         /* Ending             -HTML*/
  "Om det hδr arkivet", /* About this archive -HTML*/
  ...
  "fφrfattare",                  /* author             -HTML*/
  "datum",                          /* date               -HTML*/
  "trεd",                        /* thread             -HTML*/
  "δmne",                        /* subject            -HTML*/
  "fφr instδllningar",        /* for options        -STDOUT*/
  "Skriver brev till",              /* Writing messages to-STDOUT*/
  "Skriver datumindex till",        /* Writing date index to-STDOUT*/
  "Skriver trεdindex till",      /* Writing thread index to -STDOUT*/
  "Skriver δmnesindex till",     /* Writing subject index to-STDOUT*/
  "Skriver fφrfattarindex till", /* Writing author index to-STDOUT*/
  ...
  "Nδsta brev",                  /* Next message       -HTML*/
  "Tidigare brev",                  /* Previous message   -HTML*/
  "Kanske ett svar till",           /* Maybe in reply to  -HTML*/
  "Svar till",                      /* In reply to        -HTML*/
  "Nδsta i trεden",               /* Next in thread     -HTML*/
  "Kanske svar",                    /* Maybe reply        -HTML*/
  "Trεdsorterat",                    /* By Thread          -HTML*/
  "Δmnessorterat",                    /* By Subject         -HTML*/
  "Fφrfattarsorterat",              /* By Author          -HTML*/
  "Kan inte skapa directory",       /* Can not create directory -STDERR*/
  "Skapar katalog",               /* Creating directory -STDOUT*/
  "Konfigureringsvδrden",        /* Configuration Values -STDOUT*/
  "path",                           /* path               -STDOUT*/
  "Fick slut pε minne!",         /* Ran out of memory!-STDERR*/
  "Det hδr arkivet skapades av", /* This archive was generated by-HTML*/
  "Delar",                          /* Elements           -STDOUT*/
  "Inga delar",                     /* No Elements        -STDOUT*/
  "Kan inte φppna brevarkivet",  /* Cannot open mail archive */
  "Lδser ny header...",          /* Reading new header...-STDOUT*/
  "Laddar mailbox",                 /* Loading mailbox   -STDOUT   */
  "kodformatet stφds inte, sparat som det δr", 
                           /* encoding is not supported, stored as-is -HTML*/
  "brev",                           /* messages          -HTML*/
  "Version",                        /* Version           -STDOUT*/
  "Patchnivε",                   /* Patchlevel        -STDOUT*/
  "Dokumentation",                  /* Docs              -STDOUT*/
  "Kommando och kontrollvariabler", /* Command and Control Variables-STDOUT*/
  "Ja",                             /* Yes               -STDOUT*/
  "Nej",                            /* No                -STDOUT*/
  "Om arkivet: ej anvδnd",      /* About the archive: not used-STDOUT */
  "Andra arkiv: ej anvδnd",      /* Other archives: not used-STDOUT*/
  "adress ej anvδnd",            /* address not used  -STDOUT*/
  "Inbyggd <BODY> anvδnd",       /* Builtin <BODY> statement used-STDOUT*/
  "Kan inte lδsa bde frεn fil och stdin.", 
                           /* Cannot read from both file and stdin. -STDERR*/
  ...
  "Konfigurationsfil att lδsa in",   /* Configuration file to read in -STDOUT*/
  "Directory att spara HTML-filerna i", 
                            /* The directory to save HTML files in -STDOUT*/
  "Lδs breven frεn standard in", /* Read messages from standard input-STDOUT*/
  "Namnet pε utarkivet",         /* What to name the output archive-STDOUT*/
  "Brevarkiv att lδsa in",       /* Mail archive to read in -STDOUT*/
  ...
  "Skriv φver tidigare brev",    /* Overwrite previous messages -STDOUT*/
  "Ange sprεk att anvδnda",   /* Specify language to use -STDOUT*/
  "Anvδndning",                  /* Usage                   -STDOUT*/
  "Sprεk ej supportat",          /* Language not supported  -STDERR*/
  "Ej angivet",                     /* Not set                 -STDOUT*/
  "Ej anvδnt",                   /* Not used                -STDOUT*/
  "Skapade bilagefil",          /* Created attachment file -STDOUT*/
  "bilaga",                      /* attachment              -HTML*/
  "mode",                           /* mode                    -STDOUT*/
  "Lδser gamla headers",         /* Reading old headers     -STDOUT*/
  "",                               /* for alignment only   -STDOUT*/
  "FEL",                            /* ERROR                   -STDERR*/
  "Adressen fφr att posta till listan", 
                           /* The submission address of the list-STDERR*/
  "Lδs bara ett brev frεn in",
  "Fφrfattare",                  /* author             -HTML*/
  "Datum",                          /* date               -HTML*/
  "Δmne",                        /* subject            -HTML*/
  "E-postfunktioner",                   /* Mail actions (MA) header -HTML*/
  "sδnd ett nytt δmne",               /* MA New Message      -HTML*/
  "svara pε brevet",        /* MA Reply            -HTML*/
  "Sammanfattning φver mεnatliga indexfiler", /* monthly             -HTML*/
  "Sammanfattning φver εrliga indexfiler",  /* yearly              -HTML*/
  ...
  "Underhεll ett mbox-arkiv",    /* Maintain an mbox archive    -STDOUT*/
  "Kan inte bεde lδsa frεn och skriva till en mbox.", /* "Can't both read from and write to an mbox." -STDOUT*/
  ...
  "Kan inte skapa symbolisk lδnk", /* MSG_CANNOT_CREATE_SYMLINK     -STDOUT */
  "Kan inte ta bort fil", /* MSG_CANNOT_UNLINK                       -STDOUT */
  "Fφregεende mapp",  /* MSG_PREV_DIRECTORY                     -HTML */
  "Nδsta mapp",      /* MSG_NEXT_DIRECTORY                     -HTML */
  "Mapplista",  /* MSG_FOLDERS_INDEX                      -HTML */
  "Detta brev har tagits bort frεn arkivet", /* MSG_DELETED -HTML */
  "Detta brev har utgεtt",                       /* MSG_EXPIRED -HTML */
  "(borttaget brev)", /* MSG_DEL_SHORT                            -HTML */
  "Ursprunglig brevtext", /* MSG_TXT_VERSION                          -HTML */
  "This message has been filtered out",        /* MSG_FILTERED_OUT -HTML */
  "Fφrfattare",                     /* MSG_FROM             -HTML*/
  "Write haof XML files",       /* Write hoaf XML files       -STDOUT */
  "Writing haof to",            /* Writing haof to               -HTML*/
  NULL,                             /* End Of Message Table    - NOWHERE*/
};
...
char *no[] = {
  ...
  "Slutt pε brevlisten",          /* End of Messages    -HTML*/
  "Start pε brevlisten",         /* Start of Messages  -HTML*/
  "Oversikt dato",                        /* Date view          -HTML*/
  "Oversikt trεd",                      /* Thread view        -HTML*/
  ...
  "Skriver trεdindeks til",      /* Writing thread index to -STDOUT*/
  ...
  "Neste i trεden",               /* Next in thread     -HTML*/
  "Kanskje svar",                    /* Maybe reply        -HTML*/
  "Sortert etter trεd",                    /* By Thread          -HTML*/
  ...
  "Kan ikke εpne meldingsarkivet",  /* Cannot open mail archive */
  ...
  "Kan ikke lese bεde fra fil og stdin.",
                           /* Cannot read from both file and stdin. -STDERR*/
  ...
  "Konfigurasjonsfil til ε lese inn",   /* Configuration file to read in -STDOUT*/
  "Katalog til ε spare HTML-filene i",
                            /* The directory to save HTML files in -STDOUT*/
  "Les brevene fra stdin", /* Read messages from standard input-STDOUT*/
  "Navn pε utarkivet",         /* What to name the output archive-STDOUT*/
  ...
  "Vise versjonsinformasjon og avslutte",
                                /* Show version information and exit -STDOUT*/
  "Oppdatere arkivet med ιn melding", /*Update archive by one article -STDOUT*/
  "Skriv over andre meldinger",    /* Overwrite previous messages -STDOUT*/
  "Angi sprεk som skal benyttes",   /* Specify language to use -STDOUT*/
  "Bruk",                  /* Usage                   -STDOUT*/
  "Sprεket er ikke stψttet",          /* Language not supported  -STDERR*/
  ...
  "Lag ny trεd",               /* MA New Message      -HTML*/
  "besvare meldingen",        /* MA Reply            -HTML*/
  "Sammenfatning over mεnedlige indeksfiler", /* monthly             -HTML*/
  "Sammenfatning over εrlige indeksfiler",  /* yearly              -HTML*/
  "Bygger en GDBM-headercache",   /* Build a GDBM header cache   -STDOUT*/
  ...
  "Kan ikke bεde lese fra og skrive til en mbox.", /* "Can't both read from and write to an mbox."-STDOUT*/
  ...
  "Dette meldingen har utgεtt",                       /* MSG_EXPIRED -HTML */
...
** Μερικές εκφράσεις που βγαίνουν μόνο στο STDOUT/STDERROR
** είναι σκόπιμα αμετάφραστες ...
** Όποιος ξέρει τις ακριβές μεταφράσεις για τα παρακάτω ας
** μου τις στείλει για να κάνουμε update !
*/

char *gr[] = {       /* Greek */
  "Νέο Μήνυμα",              		/* New Message        -HTML*/
  "Απάντηση",                   	/* Reply              -HTML*/
  "Σχετικά με αυτή τη λίστα",         	/* About this list    -HTML*/
  "Τέλος Μηνυμάτων",                   	/* End of Messages    -HTML*/
  "Αρχή Μηνυμάτων",                 	/* Start of Messages  -HTML*/
  "Προβολή ανα ημέρα",            	/* Date view          -HTML*/
  "Προβολή ανά thread",                	/* Thread view        -HTML*/
  "Προβολή ανά θέμα",                	/* Subject view       -HTML*/
  "Προβολή ανά συγγραφέα",          	/* Author view        -HTML*/
  "Aλλες ομάδες",                      	/* Other groups       -HTML*/
  "Μηνύματα",                          	/* Messages           -HTML*/
  "Αρχή",                               /* Starting           -HTML*/
  "Τέλος",                            	/* Ending             -HTML*/
  "Σχετικά με αυτό το αρχείο",       	/* About this archive -HTML*/
  "ταξινομημένα ανά",            	/* sorted by 	      -HTML*/
  "Aλλα Mail Αρχεία",                 	/* Other mail archives -HTML*/
  "Ανά Ημερομηνία",                 	/* By Date             -HTML*/
  "Τα πιο καινούρια μηνύματα",        	/* Most recent messages-HTML*/
  "συγγραφέα",                        	/* author              -HTML*/
  "ημερομηνία",          		/* date                -HTML*/
  "thread",                       	/* thread              -HTML*/
  "θέμα",                              	/* subject             -HTML*/
  "για επιλογές",                      	/* for options       -STDOUT*/
  "Γράφω τα Μηνύματα στο",              /* Writing messages to-STDOUT*/
  "Γράφω το Ευρετήριο ανά ημέρα",    	/* Writing date index to-STDOUT*/
  "Γράφω το Ευρετήριο ανά thread",    	/* Writing thread index to -STDOUT*/
  "Γράφω το Ευρετήριο ανά Θέμα",     	/* Writing subject index to-STDOUT*/
  "Γράφω το Ευρετήριο ανά συγγραφέα",  	/* Writing author index to-STDOUT*/
  "Τελευταία ημερομηνία",              	/* Last message date   -HTML*/
  "Αρχειοποιήθηκε",                   	/* Archived on         -HTML*/
  "Δεν μπορώ να κάνω chmod",      	/* Can not chmod     -STDERR*/
  "Δεν μπορώ να γράψω",           	/* Could not write   -STDERR*/
  "Επόμενο μήνυμα",                 	/* Next message        -HTML*/
  "Προηγούμενο μήνυμα",                  /* Previous message    -HTML*/
  "Ίσως σαν απάντηση στο",           	/* Maybe in reply to   -HTML*/
  "Σαν απάντηση στο",               	/* In reply to         -HTML*/
  "Επόμενο στο thread",                 /* Next in thread      -HTML*/
  "Πιθανή απάντηση",                   	/* Maybe reply         -HTML*/
  "Ανά Thread",                     	/* By Thread           -HTML*/
  "Ανά Θέμα",                         	/* By Subject          -HTML*/
  "Ανά συγγραφέα",                     	/* By Author           -HTML*/
  "Δεν μπορώ να δημιουργήσω το directory", /* Can not create directory -STDERR*/
  "Δημιουργώ το directory",          	/* Creating directory -STDOUT*/
  "configuration",                 	/* Configuration Values -STDOUT*/
  "path",                            	/* path              -STDOUT*/
  "Δεν υπάρχει άλλη διαθέσιμη μνήμη", 	/* Ran out of memory!-STDERR*/
  "Αυτό το αρχείο δημιουργήθηκε απο",  	/* This archive was generated by-HTML*/
  "Στοιχεία",                        	/* Elements          -STDOUT*/
  "Κανένα στοιχείο",                	/* No Elements       -STDOUT*/
  "Δεν μπορώ να ανοίξω το αρχείο με τα μηνύματα",     /* Cannot open mail archive */
  "Διαβάζω τα καινούρια headers",    	/* Reading new header...-STDOUT*/
  "Φορτώνω το mailbox",               	/* Loading mailbox      -STDOUT*/
  "η κωδικοποίηση δεν υποστηρίζεται, τα αποθηκεύω σαν", 
                        		/* encoding is not supported, stored as-is -HTML*/
  "μηνύματα",                          	/* messages             -HTML*/
  "Έκδοση",                        	/* Version            -STDOUT*/
  "Patchlevel",               		/* Patchlevel         -STDOUT*/
  "Κέιμενα",                          	/* Docs               -STDOUT*/
  "Εντολή και διοικητικές μεταβλητές", 	/* Command and Control Variables-STDOUT*/
  "Ναί",                            	/* Yes                -STDOUT*/
  "Όχι",                         	/* No                 -STDOUT*/
  "Σχετικά με το αρχείο: Δέν χρησιμοποιήθηκε",    /* About the archive: not used-STDOUT */
  "Aλλο αρχείο: Δέν χρησιμοποιήθηκε", 	/* Other archives: not used-STDOUT*/
  "Διεύθυνση: Δέν χρησιμοποιήθηκε", 	/* address not used        -STDOUT*/
  "Το ήδη υπάρχον <BODY> χρησιμοποιήθηκε",   	/* Builtin <BODY> statement used-STDOUT*/
  "Δεν μπορώ να διαβάσω απο το αρχείο και το stdin.", /* Cannot read from both file and stdin. -STDERR*/
  "Επιλογές",                      	/* Options                -STDOUT*/
  "URL για άλλα αρχεία",           	/* URL to other archives  -STDOUT*/
  "URL για πληροφορίες για αυτό το αρχείο",  
                                      	/* URL to archive information -STDOUT*/
  "Αρχείο με παραμέτρους για να διαβάσω", 
                                    	/* Configuration file to read in -STDOUT*/
  "Το directory για να αποθηκέυσω τα HTML αρχεία ", 
                              		/* The directory to save HTML files in -STDOUT*/
  "Διάβασε τα μηνύματα απο τη στάνταρ είσοδο",
                                	/* Read messages from standard input -STDOUT*/
  "Πως πρέπει να ονομαστεί το αρχείο",   
                                  	/* What to name the output archive -STDOUT*/
  "Όνομα του Mail-αρχείου για να διαβαστεί",            /* Mail archive to read in -STDOUT*/
  "Δείχνει τη πρόοδο",                	/* Show progress           -STDOUT*/
  "Δείχνει μόνο τις παραμέτρους", 	/* Show configuration variables only -STDOUT*/
  "Δείχνει πληροφορίες για την έκδοση και τελειώνει",             /* Show version information and exit -STDOUT*/
  "Ανανεώνει το αρχείο με ένα άρθρο",  	/* Update archive by one article -STDOUT*/
  "Γράφει πάνω απο τα προηγούμενα μηνύματα", /* Overwrite previous messages -STDOUT*/
  "Καθορίζει τη γλώσσα που θα χρησιμοποιηθεί",                      /* Specify language to use -STDOUT*/
  "Χρήση",                           	/* Usage -STDOUT*/
  "Η γλώσσα δεν υποστηρίζεται",		/* Language not supported  -STDERR*/
  "Δεν τέθηκε",                        	/* Not set               -STDOUT*/
  "Δεν χρησιμοποιήθηκε",             	/* Not used              -STDOUT*/
  "Δημιουργήθηκε επισυναπτόμενο αρχείο",           /* Created attachment file -STDOUT*/
  "Επισυναπτόμενο",                   	/* attachment           -HTML*/
  "Κατάσταση",                        	/* mode                 -STDOUT*/
  "Διαβάζω τα παλιά headers",          	/* Reading old headers  -STDOUT*/
  "",       				/* for alignment only -STDOUT*/
  "ΛΑΘΟΣ",                       	/* ERROR                       -STDERR*/
  "Η διεύθυνση της λίστας για υποβολή emails", 
                           		/* The submission address of the list-STDERR*/
  "Διάβασε μόνο ένα email απο την είσοδο", /* Read only one mail from input */
  "Συγγραφέας",                        	/* author              -HTML*/
  "Ημερομηνία",                      	/* date                -HTML*/
  "Θέμα",                              	/* subject             -HTML*/
  "Mail ενέργειες",                  	/* Mail actions (MA) header -HTML*/
  "Στείλε ενα καινούριο μήνυμα ",    	/* MA New Message      -HTML*/
  "Απάντησε σε αυτό το μήνυμα",      	/* MA Reply            -HTML*/
  "Περίληψη των μηνιαίων ευρετήριων",  	/* monthly             -HTML*/
  "Περίληψη των ετήσιων ευρετήριων",  	/* yearly              -HTML*/
  "Build a GDBM header cache",   	/* Build a GDBM header cache   -STDOUT*/
  "Δημιουργώ το gdbm ευρετήριο... ",   	/* Creating gdbm index         -STDOUT*/
  "Δεν μπορώ να δημιουργήσω το gdbm αρχείο... ",  /* Can't create gdbm index     -STDOUT*/
  "Διατήρησε το mbox αρχείο",    	/* Maintain an mbox archive    -STDOUT*/
  "Δεν είναι δυνατό να διαβάσω και να γράψω στο mbox ταυτόχρονα", /* "Can't both read from and write to an mbox." -STDOUT*/
  "Προβολή Επισύναψης",             	/* Attachment view       -HTML*/
  "Ανά μηνύματα με επισυνάψεις",	/* By messages with attachments -HTML*/
  "Γράφω το ευρετήριο των επισυναπτώμενων",	  /* Writing attachment index to -STDOUT*/
  "bytes",		    		/* file size, so far only for attachments  -HTML */
  "Δεν μπορώ να δημιουργήσω το συμβολικό σύνδεσμο", /* MSG_CANNOT_CREATE_SYMLINK     -STDOUT */
  "Δεν μπορώ να απομακρύνω το μήνυμα", 	/* MSG_CANNOT_UNLINK                       -STDOUT */
  "Προηγούμενος κατάλογος",  		/* MSG_PREV_DIRECTORY                     -HTML */
  "Επόμενος κατάλογος",      		/* MSG_NEXT_DIRECTORY                     -HTML */
  "Λίστα καταλόγων",  			/* MSG_FOLDERS_INDEX                      -HTML */
  "Αυτό το μήνυμα έχει σβηστεί απο το αρχείο", /* MSG_DELETED -HTML */
  "Αυτό το μήνυμα έχει λήξει",      	/* MSG_EXPIRED -HTML */
  "(σβησμένο μήνυμα)", 			/* MSG_DEL_SHORT                            -HTML */
