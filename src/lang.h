...
char *is[] = {       /* Icelandic */
  "Nıtt bréf",                   /* New Message        -HTML*/
  "Svar",                              /* Reply              -HTML*/
  "Um şennan lista",                /* About this list    -HTML*/
  "Endir safns",                       /* End of Messages    -HTML*/
  "Upphaf safns",                      /* Start of Messages  -HTML*/
  "Rağağ e. dagssetningum",      /* Date view          -HTML*/
  "Rağağ e. umræğum",      /* Thread view        -HTML*/
  "Rağağ e. viğfangsefnum",   /* Subject view       -HTML*/
  "Rağağ e. höfundum",        /* Author view        -HTML*/
  "Ağrir flokkar",                  /* Other groups       -HTML*/
  "Bréfum",                         /* Messages           -HTML*/
  "Frá",                            /* Starting           -HTML*/
  "Til",                               /* Ending             -HTML*/
  "Um şetta safn",                  /* About this archive -HTML*/
  "Rağa eftir",                     /* Messages sorted by -HTML*/
  "Önnur söfn",                  /* Other mail archives -HTML*/
  "eftir dagssetningum",               /* By Date             -HTML*/
  "Nıjustu bréfin",              /* Most recent messages-HTML*/
  "höfundum",                       /* author              -HTML*/
  "dags.",                             /* date                -HTML*/
  "umræğum",                     /* thread              -HTML*/
  "viğfangsefnum",                  /* subject             -HTML*/
  "for options",                       /* for options       -STDOUT*/
  "Writing messages to",               /* Writing messages to-STDOUT*/
  "Writing date index to",             /* Writing date index to-STDOUT*/
  "Writing thread index to",           /* Writing thread index to -STDOUT*/
  "Writing subject index to",          /* Writing subject index to-STDOUT*/
  "Writing author index to",           /* Writing author index to-STDOUT*/
  "Dags. síğasta bréfs",      /* Last message date   -HTML*/
  "Síğasta bréf móttekiğ", /* Archived on         -HTML*/
  "Can not chmod",                     /* Can not chmod     -STDERR*/
  "Could not write",                   /* Could not write   -STDERR*/
  ...
  "Næst í umræğu",         /* Next in thread      -HTML*/
  "Mögulegt svar",                  /* Maybe reply         -HTML*/
  "eftir umræğum",               /* By Thread           -HTML*/
  "eftir viğfangsefnum",            /* By Subject          -HTML*/
  ...
  "Reading new header...",             /* Reading new header...-STDOUT   */
  "Loading mailbox",                   /* Loading mailbox      -STDOUT   */
  "framandi kóğun, geymt óbreytt", /* encoding is not supported, stored as-is -HTML*/
  "bréf.",                          /* messages             -HTML*/
  "Version",                           /* Version            -STDOUT*/
  "Patchlevel",                        /* Patchlevel         -STDOUT*/
  "Docs",                              /* Docs               -STDOUT*/
...
** Ìåñéêİò åêöñÜóåéò ğïõ âãáßíïõí ìüíï óôï STDOUT/STDERROR
** åßíáé óêüğéìá áìåôÜöñáóôåò ...
** ¼ğïéïò îİñåé ôéò áêñéâİò ìåôáöñÜóåéò ãéá ôá ğáñáêÜôù áò
** ìïõ ôéò óôåßëåé ãéá íá êÜíïõìå update !
*/

char *gr[] = {       /* Greek */
  "Íİï ÌŞíõìá",              		/* New Message        -HTML*/
  "ÁğÜíôçóç",                   	/* Reply              -HTML*/
  "Ó÷åôéêÜ ìå áõôŞ ôç ëßóôá",         	/* About this list    -HTML*/
  "Ôİëïò ÌçíõìÜôùí",                   	/* End of Messages    -HTML*/
  "Áñ÷Ş ÌçíõìÜôùí",                 	/* Start of Messages  -HTML*/
  "ĞñïâïëŞ áíá çìİñá",            	/* Date view          -HTML*/
  "ĞñïâïëŞ áíÜ thread",                	/* Thread view        -HTML*/
  "ĞñïâïëŞ áíÜ èİìá",                	/* Subject view       -HTML*/
  "ĞñïâïëŞ áíÜ óõããñáöİá",          	/* Author view        -HTML*/
  "Aëëåò ïìÜäåò",                      	/* Other groups       -HTML*/
  "Ìçíıìáôá",                          	/* Messages           -HTML*/
  "Áñ÷Ş",                               /* Starting           -HTML*/
  "Ôİëïò",                            	/* Ending             -HTML*/
  "Ó÷åôéêÜ ìå áõôü ôï áñ÷åßï",       	/* About this archive -HTML*/
  "ôáîéíïìçìİíá áíÜ",            	/* sorted by 	      -HTML*/
  "Aëëá Mail Áñ÷åßá",                 	/* Other mail archives -HTML*/
  "ÁíÜ Çìåñïìçíßá",                 	/* By Date             -HTML*/
  "Ôá ğéï êáéíïıñéá ìçíıìáôá",        	/* Most recent messages-HTML*/
  "óõããñáöİá",                        	/* author              -HTML*/
  "çìåñïìçíßá",          		/* date                -HTML*/
  "thread",                       	/* thread              -HTML*/
  "èİìá",                              	/* subject             -HTML*/
  "ãéá åğéëïãİò",                      	/* for options       -STDOUT*/
  "ÃñÜöù ôá Ìçíıìáôá óôï",              /* Writing messages to-STDOUT*/
  "ÃñÜöù ôï ÅõñåôŞñéï áíÜ çìİñá",    	/* Writing date index to-STDOUT*/
  "ÃñÜöù ôï ÅõñåôŞñéï áíÜ thread",    	/* Writing thread index to -STDOUT*/
  "ÃñÜöù ôï ÅõñåôŞñéï áíÜ Èİìá",     	/* Writing subject index to-STDOUT*/
  "ÃñÜöù ôï ÅõñåôŞñéï áíÜ óõããñáöİá",  	/* Writing author index to-STDOUT*/
  "Ôåëåõôáßá çìåñïìçíßá",              	/* Last message date   -HTML*/
  "Áñ÷åéïğïéŞèçêå",                   	/* Archived on         -HTML*/
  "Äåí ìğïñş íá êÜíù chmod",      	/* Can not chmod     -STDERR*/
  "Äåí ìğïñş íá ãñÜøù",           	/* Could not write   -STDERR*/
  "Åğüìåíï ìŞíõìá",                 	/* Next message        -HTML*/
  "Ğñïçãïıìåíï ìŞíõìá",                  /* Previous message    -HTML*/
  "ºóùò óáí áğÜíôçóç óôï",           	/* Maybe in reply to   -HTML*/
  "Óáí áğÜíôçóç óôï",               	/* In reply to         -HTML*/
  "Åğüìåíï óôï thread",                 /* Next in thread      -HTML*/
  "ĞéèáíŞ áğÜíôçóç",                   	/* Maybe reply         -HTML*/
  "ÁíÜ Thread",                     	/* By Thread           -HTML*/
  "ÁíÜ Èİìá",                         	/* By Subject          -HTML*/
  "ÁíÜ óõããñáöİá",                     	/* By Author           -HTML*/
  "Äåí ìğïñş íá äçìéïõñãŞóù ôï directory", /* Can not create directory -STDERR*/
  "Äçìéïõñãş ôï directory",          	/* Creating directory -STDOUT*/
  "configuration",                 	/* Configuration Values -STDOUT*/
  "path",                            	/* path              -STDOUT*/
  "Äåí õğÜñ÷åé Üëëç äéáèİóéìç ìíŞìç", 	/* Ran out of memory!-STDERR*/
  "Áõôü ôï áñ÷åßï äçìéïõñãŞèçêå áğï",  	/* This archive was generated by-HTML*/
  "Óôïé÷åßá",                        	/* Elements          -STDOUT*/
  "Êáíİíá óôïé÷åßï",                	/* No Elements       -STDOUT*/
  "Äåí ìğïñş íá áíïßîù ôï áñ÷åßï ìå ôá ìçíıìáôá",     /* Cannot open mail archive */
  "ÄéáâÜæù ôá êáéíïıñéá headers",    	/* Reading new header...-STDOUT*/
  "Öïñôşíù ôï mailbox",               	/* Loading mailbox      -STDOUT*/
  "ç êùäéêïğïßçóç äåí õğïóôçñßæåôáé, ôá áğïèçêåıù óáí", 
                        		/* encoding is not supported, stored as-is -HTML*/
  "ìçíıìáôá",                          	/* messages             -HTML*/
  "¸êäïóç",                        	/* Version            -STDOUT*/
  "Patchlevel",               		/* Patchlevel         -STDOUT*/
  "Êİéìåíá",                          	/* Docs               -STDOUT*/
  "ÅíôïëŞ êáé äéïéêçôéêİò ìåôáâëçôİò", 	/* Command and Control Variables-STDOUT*/
  "Íáß",                            	/* Yes                -STDOUT*/
  "¼÷é",                         	/* No                 -STDOUT*/
  "Ó÷åôéêÜ ìå ôï áñ÷åßï: Äİí ÷ñçóéìïğïéŞèçêå",    /* About the archive: not used-STDOUT */
  "Aëëï áñ÷åßï: Äİí ÷ñçóéìïğïéŞèçêå", 	/* Other archives: not used-STDOUT*/
  "Äéåıèõíóç: Äİí ÷ñçóéìïğïéŞèçêå", 	/* address not used        -STDOUT*/
  "Ôï Şäç õğÜñ÷ïí <BODY> ÷ñçóéìïğïéŞèçêå",   	/* Builtin <BODY> statement used-STDOUT*/
  "Äåí ìğïñş íá äéáâÜóù áğï ôï áñ÷åßï êáé ôï stdin.", /* Cannot read from both file and stdin. -STDERR*/
  "Åğéëïãİò",                      	/* Options                -STDOUT*/
  "URL ãéá Üëëá áñ÷åßá",           	/* URL to other archives  -STDOUT*/
  "URL ãéá ğëçñïöïñßåò ãéá áõôü ôï áñ÷åßï",  
                                      	/* URL to archive information -STDOUT*/
  "Áñ÷åßï ìå ğáñáìİôñïõò ãéá íá äéáâÜóù", 
                                    	/* Configuration file to read in -STDOUT*/
  "Ôï directory ãéá íá áğïèçêİõóù ôá HTML áñ÷åßá ", 
                              		/* The directory to save HTML files in -STDOUT*/
  "ÄéÜâáóå ôá ìçíıìáôá áğï ôç óôÜíôáñ åßóïäï",
                                	/* Read messages from standard input -STDOUT*/
  "Ğùò ğñİğåé íá ïíïìáóôåß ôï áñ÷åßï",   
                                  	/* What to name the output archive -STDOUT*/
  "¼íïìá ôïõ Mail-áñ÷åßïõ ãéá íá äéáâáóôåß",            /* Mail archive to read in -STDOUT*/
  "Äåß÷íåé ôç ğñüïäï",                	/* Show progress           -STDOUT*/
  "Äåß÷íåé ìüíï ôéò ğáñáìİôñïõò", 	/* Show configuration variables only -STDOUT*/
  "Äåß÷íåé ğëçñïöïñßåò ãéá ôçí İêäïóç êáé ôåëåéşíåé",             /* Show version information and exit -STDOUT*/
  "Áíáíåşíåé ôï áñ÷åßï ìå İíá Üñèñï",  	/* Update archive by one article -STDOUT*/
  "ÃñÜöåé ğÜíù áğï ôá ğñïçãïıìåíá ìçíıìáôá", /* Overwrite previous messages -STDOUT*/
  "Êáèïñßæåé ôç ãëşóóá ğïõ èá ÷ñçóéìïğïéçèåß",                      /* Specify language to use -STDOUT*/
  "×ñŞóç",                           	/* Usage -STDOUT*/
  "Ç ãëşóóá äåí õğïóôçñßæåôáé",		/* Language not supported  -STDERR*/
  "Äåí ôİèçêå",                        	/* Not set               -STDOUT*/
  "Äåí ÷ñçóéìïğïéŞèçêå",             	/* Not used              -STDOUT*/
  "ÄçìéïõñãŞèçêå åğéóõíáğôüìåíï áñ÷åßï",           /* Created attachment file -STDOUT*/
  "Åğéóõíáğôüìåíï",                   	/* attachment           -HTML*/
  "ÊáôÜóôáóç",                        	/* mode                 -STDOUT*/
  "ÄéáâÜæù ôá ğáëéÜ headers",          	/* Reading old headers  -STDOUT*/
  "",       				/* for alignment only -STDOUT*/
  "ËÁÈÏÓ",                       	/* ERROR                       -STDERR*/
  "Ç äéåıèõíóç ôçò ëßóôáò ãéá õğïâïëŞ emails", 
                           		/* The submission address of the list-STDERR*/
  "ÄéÜâáóå ìüíï İíá email áğï ôçí åßóïäï", /* Read only one mail from input */
  "Óõããñáöİáò",                        	/* author              -HTML*/
  "Çìåñïìçíßá",                      	/* date                -HTML*/
  "Èİìá",                              	/* subject             -HTML*/
  ...
  "ÄéáôŞñçóå ôï mbox áñ÷åßï",    	/* Maintain an mbox archive    -STDOUT*/
  "Äåí åßíáé äõíáôü íá äéáâÜóù êáé íá ãñÜøù óôï mbox ôáõôü÷ñïíá", /* "Can't both read from and write to an mbox." -STDOUT*/
  "ĞñïâïëŞ Åğéóıíáøçò",             	/* Attachment view       -HTML*/
  "ÁíÜ ìçíıìáôá ìå åğéóõíÜøåéò",	/* By messages with attachments -HTML*/
  "ÃñÜöù ôï åõñåôŞñéï ôùí åğéóõíáğôşìåíùí",	  /* Writing attachment index to -STDOUT*/
  "bytes",		    		/* file size, so far only for attachments  -HTML */
  "Äåí ìğïñş íá äçìéïõñãŞóù ôï óõìâïëéêü óıíäåóìï", /* MSG_CANNOT_CREATE_SYMLINK     -STDOUT */
  "Äåí ìğïñş íá áğïìáêñıíù ôï ìŞíõìá", 	/* MSG_CANNOT_UNLINK                       -STDOUT */
  "Ğñïçãïıìåíïò êáôÜëïãïò",  		/* MSG_PREV_DIRECTORY                     -HTML */
  "Åğüìåíïò êáôÜëïãïò",      		/* MSG_NEXT_DIRECTORY                     -HTML */
  "Ëßóôá êáôáëüãùí",  			/* MSG_FOLDERS_INDEX                      -HTML */
  "Áõôü ôï ìŞíõìá İ÷åé óâçóôåß áğï ôï áñ÷åßï", /* MSG_DELETED -HTML */
  "Áõôü ôï ìŞíõìá İ÷åé ëŞîåé",      	/* MSG_EXPIRED -HTML */
  "(óâçóìİíï ìŞíõìá)", 			/* MSG_DEL_SHORT                            -HTML */
  "Ğñüôõğï êåßìåíï ôïõ ìçíıìáôïò", 	/* MSG_TXT_VERSION                          -HTML */
  "Áõôü ôï ìŞíõìá İ÷åé öéëôñáñéóôåß ",  /* MSG_FILTERED_OUT -HTML */
  "Óõããñáöİáò",       			/* MSG_FROM              -HTML*/
  NULL,                           	/* End Of Message Table - NOWHERE*/
};
...
char *ru[] = {     /* Russian */
  "îÏ×ÏÅ ÓÏÏÂİÅÎÉÅ",             /* New Message        -HTML*/
  "ïÔ×ÅÔ",                       /* Reply              -HTML*/
  "ï ÓĞÉÓËÅ",                    /* About this list    -HTML*/
  "ëÏÎÅÃ ÓÏÏÂİÅÎÉÊ",             /* End of Messages    -HTML*/
  "îÁŞÁÌÏ ÓÏÏÂİÅÎÉÊ",            /* Start of Messages  -HTML*/
  "ğÏ ÄÁÔÅ",                     /* Date view          -HTML*/
  "ğÏ ÎÉÔÑÍ",                    /* Thread view        -HTML*/
  "ğÏ ÔÅÍÁÍ",                    /* Subject view       -HTML*/
  "ğÏ Á×ÔÏÒÁÍ",                  /* Author view        -HTML*/
  "äÒÕÇÉÅ ÇÒÕĞĞÙ",               /* Other groups       -HTML*/
  "óÏÏÂİÅÎÉÑ",                   /* Messages           -HTML*/
  "îÁŞÁÌÏ",                      /* Starting           -HTML*/
  "ëÏÎÅÃ",                       /* Ending             -HTML*/
  "ïÂ ÜÔÏÍ ÁÒÈÉ×Å",              /* About this archive -HTML*/
  "ÏÔÓÏÒÔÉÒÏ×ÁÎÙ ĞÏ",            /* Messages sorted by -HTML*/
  "äÒÕÇÉÅ ĞÏŞÔÏ×ÙÅ ÁÒÈÉ×Ù",      /* Other mail archives -HTML*/
  "ğÏ ÄÁÔÅ",                     /* By Date             -HTML*/
  "óÁÍÙÅ ĞÏÓÌÅÄÎÉÅ ÓÏÏÂİÅÎÉÑ",   /* Most recent messages-HTML*/
  "Á×ÔÏÒ",                       /* author              -HTML*/
  "ÄÁÔÁ",                        /* date                -HTML*/
  "ÎÉÔØ",                        /* thread              -HTML*/
  "ÔÅÍÁ",                        /* subject             -HTML*/
  "ÄÌÑ ÏĞÃÉÊ",                   /* for options       -STDOUT*/
  "ğÉÛÕ ÓÏÏÂİÅÎÉÅ ×",           /* Writing messages to-STDOUT*/
  "ğÉÛÕ date index ×",          /* Writing date index to-STDOUT*/
  "ğÉÛÕ thread index ×",        /* Writing thread index to -STDOUT*/
  "ğÉÛÕ subject index ×",       /* Writing subject index to-STDOUT*/
  "ğÉÛÕ author index ×",        /* Writing author index to-STDOUT*/
  "äÁÔÁ ĞÏÓÌÅÄÎÅÇÏ ÓÏÏÂİÅÎÉÑ",   /* Last message date   -HTML*/
  "áÒÈÉ×ÉÒÏ×ÁÎÏ ×",             /* Archived on         -HTML*/
  "îÅ ÍÏÇÕ chmod",               /* Can not chmod     -STDERR*/
  "îÅ ÍÏÇÕ ÚÁĞÉÓÁÔØ",              /* Could not write   -STDERR*/
  "óÌÅÄÕÀİÅÅ ÓÏÏÂİÅÎÉÅ",         /* Next message        -HTML*/
  "ğÒÅÄÙÄÕİÅÅ ÓÏÏÂİÅÎÉÅ",        /* Previous message    -HTML*/
  "÷ÏÚÍÏÖÎÏ ÜÔÏ ÏÔ×ÅÔ ÎÁ",        /* Maybe in reply to   -HTML*/
  "üÔÏ ÏÔ×ÅÔ ÎÁ",                 /* In reply to         -HTML*/
  "óÌÅÄÕÀİÅÅ × ÎÉÔÉ",            /* Next in thread      -HTML*/
  "÷ÏÚÍÏÖÎÏ ÏÔ×ÅÔ",              /* Maybe reply         -HTML*/
  "ğÏ ÎÉÔÑÍ",                    /* By Thread           -HTML*/
  "ğÏ ÔÅÍÁÍ",                    /* By Subject          -HTML*/
  "ğÏ Á×ÔÏÒÁÍ",                  /* By Author           -HTML*/
  "îÅ ÍÏÇÕ ÓÏÚÄÁÔØ ÄÉÒÅËÔÏÒÉÀ",  /* Can not create directory -STDERR*/
  "óÏÚÄÁÀ ÄÉÒÅËÔÏÒÉÀ",           /* Creating directory -STDOUT*/
  "ğÁÒÁÍÅÔÒÙ ËÏÎÆÉÇÕÒÁÃÉÉ",      /* Configuration Values -STDOUT*/
  "ĞÕÔØ",                        /* path              -STDOUT*/
  "îÅ È×ÁÔÁÅÔ ĞÁÍÑÔÉ!",          /* Ran out of memory!-STDERR*/
  "üÔÏÔ ÁÒÈÉ× ÂÙÌ ÓÇÅÎÅÒÉÒÏ×ÁÎ", /* This archive was generated by-HTML*/
  "üÌÅÍÅÎÔÏ×",                   /* Elements          -STDOUT*/
  "îÅÔ ÜÌÅÍÅÎÔÏ×",               /* No Elements       -STDOUT*/
  "îÅ ÍÏÇÕ ÏÔËÒÙÔØ ĞÏŞÔÏ×ÙÊ ÁÒÈÉ×", /* Cannot open mail archive */
  "şÉÔÁÀ ÎÏ×ÙÊ ÚÁÇÏÌÏ×ÏË...",    /* Reading new header...-STDOUT   */
  "úÁÇÒÕÖÁÀ mailbox",            /* Loading mailbox      -STDOUT   */
  "ËÏÄÉÒÏ×ËÁ ÎÅ ĞÏÄÄÅÒÖÉ×ÁÅÔÓÑ, ÚÁĞÉÓÁÎÏ ËÁ ÅÓÔØ", /* encoding is not supported, stored as-is -HTML*/
  "ÓÏÏÂİ.",                      /* messages             -HTML*/
  "÷ÅÒÓÉÑ",                      /* Version            -STDOUT*/
  "Patchlevel",                  /* Patchlevel         -STDOUT*/
  "äÏËÕÍÅÎÔÏ×",                  /* Docs               -STDOUT*/
  "ëÏÍÁÎÄÎÙÅ É ÕĞÒÁ×ÌÑÀİÉÅ ĞÁÒÁÍÅÔÒÙ",       /* Command and Control Variables-STDOUT*/
  "äÁ",                          /* Yes                -STDOUT*/
  "îÅÔ",                         /* No                 -STDOUT*/
  "ïÂ ÁÒÈÉ×Å: ÎÅ ÉÓĞÏÌØÚÏ×ÁÎ", /* About the archive: not used-STDOUT */
  "äÒÕÇÉÅ ÁÒÈÉ×Ù: ÎÅ ÉÓĞÏÌØÚÏ×ÁÎÙ",    /* Other archives: not used-STDOUT*/
  "ÁÄÒÅÓ ÎÅ ÉÓĞÏÌØÚÏ×ÁÎ",            /* address not used        -STDOUT*/
  "éÓĞÏÌØÚÏ×ÁÎ ×ÓÔÒÏÅÎÎÙÊ ÏĞÅÒÁÔÏÒ <BODY>", /* Builtin <BODY> statement used-STDOUT*/
  "îÅ ÍÏÇÕ ÏÄÎÏ×ÒÅÍÅÎÎÏ ŞÉÔÁÔØ É ÆÁÊÌ and stdin.", /* Cannot read from both file and stdin. -STDERR*/
  "ïĞÃÉÉ",                     /* Options                -STDOUT*/
  "URL Ë ÄÒÕÇÉÍ ÁÒÈÉ×ÁÍ",       /* URL to other archives  -STDOUT*/
  "URL Ë ÁÒÈÉ×ÎÏÊ ÉÎÆÏÒÍÁÃÉÉ",  /* URL to archive information -STDOUT*/
  "ëÏÎÆÉÇÕÒÁÃÉÏÎÎÙÊ ÆÁÊÌ ÄÌÑ ŞÔÅÎÉÑ Ó", /* Configuration file to read in -STDOUT*/
  "äÉÒÅËÔÏÒÉÑ ÄÌÑ ÓÏÈÒÁÎÅÎÉÑ HTML ÆÁÊÌÏ× ×", /* The directory to save HTML files in -STDOUT*/
  "şÔÅÎÉÅ ÓÏÏÂİÅÎÉÊ ÓÏ ÓÔÁÎÄÁÒÎÔÎÏÇÏ ××ÏÄÁ",/* Read messages from standard input -STDOUT*/
  "ëÁËÏÅ ÉÍÑ ×ÙÈÏÄÎÏÇÏ ÁÒÈÉ×Á", /* What to name the output archive -STDOUT*/
  "ğÏŞÔÏ×ÙÊ ÁÒÈÉ× ÄÌÑ ŞÔÅÎÉÑ Ó",     /* Mail archive to read in -STDOUT*/
  "ğÏËÁÚÁÔØ ĞÒÏÇÒÅÓÓ",               /* Show progress           -STDOUT*/
  "ğÏËÁÚÁÔØ ÔÏÌØËÏ ĞÁÒÁÍÅÔÒÙ ËÏÎÆÉÇÕÒÁÃÉÉ", /* Show configuration variables only -STDOUT*/
  "ğÏËÁÚÁÔØ ×ÅÒÓÉÀ É ×ÙÊÔÉ", /* Show version information and exit -STDOUT*/
  "ïÂÎÏ×ÉÔØ ÁÒÈÉ× ĞÏ ÏÄÎÏÊ ÓÔÁÔØÅ", /* Update archive by one article -STDOUT*/
  "ğÅÒÅÚÁĞÉÓÁÔØ ĞÒÅÄÙÄÕİÉÅ ÓÏÏÂİÅÎÉÑ", /* Overwrite previous messages -STDOUT*/
  "õËÁÖÉÔÅ ÉÓĞÏÌØÚÕÅÍÙÊ ÑÚÙË",     /* Specify language to use     -STDOUT*/
  "éÓĞÏÌØÚÏ×ÁÎÉÅ",                       /* Usage                       -STDOUT*/
  "ñÚÙË ÎÅ ĞÏÄÄÅÒÖÁÎ",      /* Language not supported      -STDERR*/
  "îÅ ÕÓÔÁÎÏ×ÌÅÎÏ",                     /* Not set                     -STDOUT*/
  "îÅ ÉÓĞÏÌØÚÕÅÔÓÑ",                    /* Not used                    -STDOUT*/
  "óÏÚÄÁÎ ÆÁÊÌ-×ÌÏÖÅÎÉÅ",     /* Created attachment file     -STDOUT*/
  "×ÌÏÖÅÎÉÅ",                  /* attachment                    -HTML*/
  "ÒÅÖÉÍ",                        /* mode                        -STDOUT*/
  "şÉÔÁÀ ÓÔÁÒÙÅ ÚÁÇÏÌÏ×ËÉ",         /* Reading old headers         -STDOUT*/
  "", /* for alignment only       -STDOUT*/
  "ïûéâëá",                       /* ERROR                       -STDERR*/
  "ğÒÅÄÓÔÁ×ÌÅÎÎÙÅ × ×ĞÉÓËÅ ÁÄÒÅÓÁ", /* The submission address of the list-STDERR*/
  "şÔÅÎÉÅ ÔÏÌØËÏ ÏÄÎÏÇÏ ÓÏÏÂİÅÎÉÑ ÓÏ ××ÏÄÁ",
  "á×ÔÏÒ",                      /* author              -HTML*/
  "äÁÔÁ",                        /* date                -HTML*/
  "ôÅÍÁ",                     /* subject             -HTML*/
  ...
  "îÅ ÍÏÇÕ ÏÄÎÏ×ÒÅÍÅÎÎÏ É ŞÉÔÁÔØ É ĞÉÓáÔØ ÉÚ mbox-Á.", /* "Can't both read from and write to an mbox." -STDOUT*/
  "ğÏ ×ÌÏÖÅÎÉÑÍ",   /* Attachment view       -HTML*/
  "ğÏ ÓÏÏÂİÅÎÉÑÍ Ó ×ÌÏÖÅÎÉÑÍÉ",   /* By messages with attachments -HTML*/
  "úÁĞÉÓÙ×ÁÀ ÉÎÄÅËÓ ĞÏ ×ÌÏÖÅÎÉÑÍ ×",   /* Writing attachment index to -STDOUT*/
  "ÂÁÊÔ",     /* file size, so far only for attachments  -HTML */
  "îÅ ÍÏÇÕ ÓÏÚÄÁÔØ ÓÉÍ×ÏÌÉŞÅÓËÕÀ ÓÓÙÌËÕ", /* MSG_CANNOT_CREATE_SYMLINK     -STDOUT */
  "îÅ ÍÏÇÕ ÕÄÁÌÉÔØ ÆÁÊÌ", /* MSG_CANNOT_UNLINK                       -STDOUT */
  "ğÒÅÄÙÄÕİÁÑ ÄÉÒÅËÔÏÒÉÑ",  /* MSG_PREV_DIRECTORY                     -HTML */
  "óÌÅÄÕÀİÁÑ ÄÉÒÅËÔÏÒÉÑ",      /* MSG_NEXT_DIRECTORY                     -HTML */
  "óĞÉÓÏË ÄÉÒÅËÔÏÒÉÊ",  /* MSG_FOLDERS_INDEX                      -HTML */
  "üÔÏ ÓÏÏÂİÅÎÉÅ ÂÙÌÏ ÕÄÁÌÅÎÏ ÉÈ ÁÒÈÉ×Á", /* MSG_DELETED -HTML */
  "üÔÏ ÓÏÏÂİÅÎÉÅ ĞÒÏÓÒÏŞÅÎÏ",                       /* MSG_EXPIRED -HTML */
  "(ÕÄÁÌÅÎÎÏÅ ÓÏÏÂİÅÎÉÅ)", /* MSG_DEL_SHORT                            -HTML */
  "éÓÈÏÄÎÙÊ ÔÅËÓÔ ÄÁÎÎÏÇÏ ÓÏÏÂİÅÎÉÑ", /* MSG_TXT_VERSION                          -HTML */
  "üÔÏ ÓÏÏÂİÅÎÉÅ ÂÙÌÏ ÏÔÆÉÌØÔÒÏ×ÁÎÏ",        /* MSG_FILTERED_OUT -HTML */
  "ïÔ",                        /* MSG_FROM                      -HTML*/
  "úÁĞÉÓØ haof XML ÆÁÊÌÏ×",       /* Write hoaf XML files       -STDOUT */
  "úÁĞÉÓÙ×ÁÀ haof ×",            /* Writing haof to               -HTML*/
  NULL,                          /* End Of Message Table      - NOWHERE*/
};
