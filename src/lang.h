...
char *fr[] = {       /* French */
  ...
  "encodage non supportÈ, stockÈ tel quel",/* encoding is not supported, stored as-is -HTML*/
  "messages",                              /* messages             -HTML*/
  "Version",                               /* Version            -STDOUT*/
  ...
  "Liste par fichier attachÈs",            /* Attachment view  -HTML*/
  "par messages avec fichiers attachÈs",    /* By messages with attachments -HTML*/
  ...
  "Dossier prÈcÈdent",                     /* MSG_PREV_DIRECTORY                     -HTML */
