...
void print_default_css_file(char *filename)
{
    ...
    fprintf(fp, "    border: 2px solid #888;\n");
    fprintf(fp, "    border-radius: 0.5em;\n");
    fprintf(fp, "}\n");
    fprintf(fp, "\n");
    fprintf(fp, ".message-body-part {\n");
    ...
    fprintf(fp, "}\n");
    fprintf(fp, "\n");
    fprintf(fp, ".attachment-links {\n");
    fprintf(fp, "  background: aliceblue;\n");
    fprintf(fp, "  padding: 0.01em 1em;\n");
    fprintf(fp, "}\n");
    fprintf(fp, "\n");
    ...
    fprintf(fp, "   */\n");
    fprintf(fp, "    padding: 0.025em 0.75em;\n");
    fprintf(fp, "}\n");
    fprintf(fp, "\n");
